...
////////////// MAGNETOMETER ///////////////////////////////////////////////////
  ...
  if(currentMillis - previousMillis > interval && count < 1) {
 previousMillis = currentMillis;
 count = count + 1;
 desiredPosition = 280;
 }
 else if(currentMillis - previousMillis > interval && count >= 1 && count < 7) {
 previousMillis = currentMillis;
 count = count + 1;
 ...
 else if (currentMillis - previousMillis > interval && count >= 7) {
  previousMillis = currentMillis;
 count = count + 1;
  desiredPosition = 314;
 if (solenoidState == LOW)
...
headingdifference = desiredPosition - heading;
